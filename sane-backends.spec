...
%prep
%setup -q -n sane-backends-1.1.1
cd %{_builddir}/sane-backends-1.1.1
%patch1 -p1
%patch2 -p1
%patch3 -p1
pushd ..
cp -a sane-backends-1.1.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670973988
