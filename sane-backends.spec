...
%prep
%setup -q -n sane-backends-1.0.29
cd %{_builddir}/sane-backends-1.0.29
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1580698592
...
cp %{_builddir}/sane-backends-1.0.29/COPYING %{buildroot}/usr/share/package-licenses/sane-backends/74a8a6531a42e124df07ab5599aad63870fa0bd4
%make_install
