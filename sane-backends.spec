...
Source0  : https://gitlab.com/sane-project/backends/uploads/9e718daff347826f4cfe21126c8d5091/sane-backends-1.0.28.tar.gz
...
%prep
%setup -q -n sane-backends-1.0.28
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1571186253
...
cp %{_builddir}/sane-backends-1.0.28/COPYING %{buildroot}/usr/share/package-licenses/sane-backends/74a8a6531a42e124df07ab5599aad63870fa0bd4
%make_install
