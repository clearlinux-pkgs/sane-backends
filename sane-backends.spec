...
Version  : 1.3.1
Release  : 35
URL      : https://gitlab.com/sane-project/backends/-/archive/1.3.1/backends-1.3.1.tar.gz
Source0  : https://gitlab.com/sane-project/backends/-/archive/1.3.1/backends-1.3.1.tar.gz
...
%prep
%setup -q -n backends-1.3.1
cd %{_builddir}/backends-1.3.1
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
pushd ..
cp -a backends-1.3.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720033966
...
cp %{_builddir}/backends-%{version}/COPYING %{buildroot}/usr/share/package-licenses/sane-backends/4cc77b90af91e615a64ae04893fdffa7939db84c || :
export GOAMD64=v2
GOAMD64=v3
pushd ../buildavx2/
%make_install_v3
...
/usr/share/defaults/sane/lexmark_x2600.conf
...
/V3/usr/lib64/sane/libsane-lexmark_x2600.so.1.2.1
...
/usr/lib64/sane/libsane-lexmark_x2600.so
/usr/lib64/sane/libsane-lexmark_x2600.so.1
/usr/lib64/sane/libsane-lexmark_x2600.so.1.2.1
...
/usr/share/man/man5/sane-lexmark_x2600.5
