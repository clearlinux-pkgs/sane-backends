...
Source0  : https://gitlab.com/sane-project/backends/uploads/8bf1cae2e1803aefab9e5331550e5d5d/sane-backends-1.0.31.tar.gz
...
%prep
%setup -q -n sane-backends-1.0.31
cd %{_builddir}/sane-backends-1.0.31
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1598289091
...
cp %{_builddir}/sane-backends-1.0.31/COPYING %{buildroot}/usr/share/package-licenses/sane-backends/74a8a6531a42e124df07ab5599aad63870fa0bd4
%make_install
