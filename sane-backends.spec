...
Source0  : https://gitlab.com/sane-project/backends/-/archive/1.3.0/backends-1.3.0.tar.gz
...
%prep
%setup -q -n backends-1.3.0
cd %{_builddir}/backends-1.3.0
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
pushd ..
cp -a backends-1.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711065833
